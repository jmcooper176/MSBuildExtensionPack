...
namespace MSBuild.ExtensionPack.Framework
{
    ...
    /// ]]></code>    
    /// </example>
    [HelpUrl("http://www.msbuildextensionpack.com/help/3.5.12.0/html/2610c1b7-348a-901e-3c90-84a3deb99c38.htm")]
    public class Assembly : BaseAppDomainIsolatedTask
    {
        ...
        private void GetInfo()
        {
            if (this.assembly != null)
            {
                ...
                t.SetMetadata("AssemblyInformationalVersion", FileVersionInfo.GetVersionInfo(this.assembly.Location).ProductVersion);
