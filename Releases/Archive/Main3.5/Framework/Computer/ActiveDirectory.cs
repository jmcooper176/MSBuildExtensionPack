...
namespace MSBuild.ExtensionPack.Computer
{
    ...
    /// ]]></code>    
    /// </example>
    [HelpUrl("http://www.msbuildextensionpack.com/help/3.5.12.0/html/ad44953a-08cd-5898-fa63-efb8495d2a92.htm")]
        ...
        private void AddUser()
        {
            ...
            try
            {
              ...
              if (!isLocalMachineUser)
              {
                ...
                userPrincipal.UserPrincipalName = !string.IsNullOrEmpty(fullyQualifiedDomainName) ? this.User[0].ItemSpec + "@" + fullyQualifiedDomainName : this.User[0].ItemSpec;
              }
