...
//-----------------------------------------------------------------------
namespace MSBuild.ExtensionPack.Tfs2010
{
    using System;
    ...
    /// ]]></code>    
    /// </example>
    [HelpUrl("http://www.msbuildextensionpack.com/help/3.5.12.0/html/87a51246-5d06-72b5-191f-9f6976177ea6.htm")]
    public class DevEnv : ToolTask
    {
        ...
        /// <summary>
        /// The (major) version of DevEnv.com that should be invoked. Default is 10 (2010).
        /// </summary>
        public int Version
        {
        ...
        {
            string regKey = string.Format(CultureInfo.InvariantCulture, @"SOFTWARE\Microsoft\VisualStudio\{0}.0\Setup\VS", this.version);
            ...
            using (RegistryKey key = Registry.LocalMachine.OpenSubKey(regKey))
            {
                if (key != null)
                {
                    path = key.GetValue("VS7CommonDir") + @"IDE";
                }
            }
